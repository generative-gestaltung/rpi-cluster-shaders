...
//
//     init();
//     vec3 col = vec3(0., sin((coord.x+400.)*0.011*sin(coord.x*0.01+coord.y+uTime*0.1)*5.*sin(uTime*0.03))*0.5+0.4, sin((coord.x)*0.021*sin((coord.x+400.)*0.01+coord.y+uTime*10.)*sin(uTime*0.0301))*0.5+0.4);
//
//     vec2 center = vec2(400., 400.);
//
//     float phi = angle(center, coord);
//     float r = distance(center, coord);
//
//     float sides = sin(uTime)*0.6+1.5;
//     float t = mod(phi, sides) / sides;
//     float d = mix(140., 190., t);
//     float x = l1(r, d);
//
//     if (x<20.) {
//       col = vec3(0., 0., 0.);
